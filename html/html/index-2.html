...
<!-- Mirrored from upsidethemes.net/demo/news-times/html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 12 Aug 2020 12:02:17 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=utf-8" /><!-- /Added by HTTrack -->
<head>
        <meta charset="utf-8">
        <title>NEWS TIME</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <link href="../../../../fonts.googleapis.com/csse2ff.css?family=Roboto+Condensed:400italic,700italic,400,700" rel='stylesheet' type='text/css'>
        <link href="../../../../fonts.googleapis.com/css24e4.css?family=Roboto+Slab:400,300,100,700" rel='stylesheet' type='text/css'>
...
<body class="kp-home">
    <header id="page-header">
        <div class="header-top">
            <div class="container">
                <nav class="pull-left">
                    ...
                    <div class="mobile-menu clearfix">
                        ...
                        <ul class="toggle-view-menu">
                          ...
                          <li class="clearfix">
                              <h3><a href="#">Pages</a><span>+</span></h3> 
                              <div class="menu-panel clearfix">
                                  <ul>
                                  ...
                                  <ul>
                                      ...
                                      <li>
                                          ...
                                          <ul>
                                              ...
                                              <li><a href="#">Portfolio audio</a></li>
                                              <li><a href="#">Portfolio gallery</a></li>
                                              <li><a href="#">Portfolio video</a></li>
                                              <li><a href="#">Portfolio soundcloud</a></li>
                                          </ul>
                                      </li>
                                  </ul>
                              </div>
                ...
                <div class="search-box pull-right">
                    ...
                    this.value = '';" value="Enter key word" >
                        </div>
        ...
        <div class="header-middle container clearfix">
            <div class="logo pull-left">
                <a href="index-2.html"><img src="placeholders/logo.png" class="img-responsive" alt=""></a>
            </div>
        ...
        <div class="header-bottom container">
            <nav class="clearfix">
                <a href="index-2.html" class="icon-home kp-icon-home"></a>
                <ul class="sf-menu main-menu">
                    <li>
                        <a href="index-2.html">home page</a>
                    </li>
                    <li>
                        <a href="element.html">templages</a>
                        <ul>
                    ...
                    <li>
                        <a href="single.html">single posts</a>
                        <ul>
                            <li >
                                <a href="single.html">Single standard</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="single-full-width.html">Single full width</a>
                            </li>
                        </ul>
                    </li>
                    <li>
        ...
        <div class="main-top">
            <div class="owl-carousel owl-carousel-text">                    
                <div class="item clearfix">
                    ...
                    <a href="#" class="item-right">Loris Capirossi Retires, Riders Pay Tribute</a>
                </div>

                <div class="item clearfix">
                    <span class="pull-left">2</span>
                    <a href="#" class="item-right">Should There be Lights on the Park Arthur ...</a>
                </div>                    
        ...
        <div id="main-col" class="pull-left">
                      ...
                      <div class="item-lg clearfix">
                          <a href="#" class="kp-caption">
                            ...
                            <div class="caption-wrapper">
                              <h3>Should There be Lights on the Park Arthur Sledding Hill?</h3>
                            </div>
                          </a>
                      </div>
                      <!-- item-lg -->
                      <div class="item-bottom clearfix">
                          <div class="item-sm pull-left">
                              <a href="#" class="kp-caption">
                                ...
                                <div class="caption-wrapper">
                                  <h4>Loris Capirossi Retires, Riders Pay Tribute</h4>
                                </div>
                              </a>
                          </div>
                          <!-- item-sm -->
            ...
            <div class="widget-area-3 pull-right">
                ...
                <div class="owl-carousel owl-carousel-feature">
                      ...
                      <div class="item-wrapper clearfix">
                        <div class="item pull-left">
                          ...
                          <p class="kp-metadata"><span>- October 23, 2013</span></p>
                        </div>
                        <!-- item -->
                        <div class="item pull-left">
                          <p class="kp-metadata style-2">
              ...
              <div class="widget-area-6">
                        ...
                        <li>
                          <div class="item item-style-1 clearfix">
                            ...
                            <div class="item-right">
                              <h4><a href="#">US labour market shows strong rise: 236,000 new </a></h4>
                              <p class="kp-metadata"><span>- October 23, 2013</span></p>
                            </div>
                          </div>
                        </li>
                  ...
                  <!-- widget-other-post -->
                  <div class="widget widget-other-posts style-2">
                    <h3 class="widget-title">sport news</h3>
                    <p class="kp-metadata style-2">
                      <i class="icon-heart"></i><span>50</span>
                      <i class="icon-eye"></i><span>50</span>
                      <i class="icon-comment"></i><span>50</span>
                    ...
                    <ul class="list-posts list-unstyled">
                      ...
                      <li>
                        <div class="item clearfix">
                          <a href="#" class="pull-left">
                            <img src="placeholders/posts/img-6.jpg" alt="">
                          </a>
                          <div class="item-right">
                            <h4><a href="#">US labour market shows strong rise: 236,000 new </a></h4>
                            <p class="kp-metadata"><span>- October 23, 2013</span></p>
                  ...
                  <div class="widget widget-other-posts">
                    ...
                    <ul class="list-posts list-unstyled">
                      <li>
                        <div class="item item-style-1 clearfix">
                          <a href="#" class="pull-left caption">
                            <img src="placeholders/posts/img-29.jpg" alt="">
                            <p>Maecenas aliquet, elit vitae egestas lacinia, nibh purus accumsan metus, ut mollis est eros tempus sem. </p>
                            <span class="icon-plus"></span>
                          </a>
                          <div class="item-right">
            ...
            <div class="widget-area-2 pull-left">
                <div class="widget widget-last-post">
                    ...
                    <div class="owl-carousel owl-carousel-last-post">                            
                        <div class="item">
                            ...
                            <h3><a href="#">Loris Capirossi Retires, Riders Pay Tribute</a></h3>
                            <p class="kp-metadata">
                ...
                <div class="widget widget-ads">
                    <a href="#"><img src="placeholders/ads.jpg" alt=""></a>
                </div>
                <!-- widget-ads -->
                <div class="widget widget-tw">
                    ...
                    <a href="#" class="clearfix"><span class="icon-twitter4"></span>Follow</a>
                </div>
                <!-- widget-tw -->
            </div>
            <!-- widget-area-2 -->
            ...
            <div class="widget-area-4">
               <div class="widget widget-photos">
                  <h3 class="widget-title">Inspiring Photos</h3>
                      ...
                      <ul class="list-unstyled">
                        <li>
                          <a href="#" class="caption">
                            ...
                            <h4>Maecenas aliquet, elit vitae egestas lacinia</h4>
                            <span class="icon-plus"></span>
                          </a>
                        </li>
                        <li>
                  ...
                  <a href="gallery.html" class="to-gallery">See more</a>
                </div>
                <!-- widget-photos -->
            </div>
            <!-- widget-area-4 -->
        ...
        <div id="sidebar" class="pull-left">
            <div class="widget widget-random-post">
                ...
                <ul class="list-posts list-unstyled">
                    <li>
                        <div class="item clearfix">
                            <a href="#" class="pull-left"><img src="placeholders/posts/img-6.jpg" alt=""></a>
                            <div class="item-right">
                                <h4><a href="#">Loris Capirossi Retires, Riders Pay Tribute</a></h4>
                                <p class="kp-metadata"><span>- October 23, 2013</span></p>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="item clearfix">
                            <a href="#" class="pull-left"><img src="placeholders/posts/img-7.jpg" alt=""></a>
                            <div class="item-right">
                                <h4><a href="#">Loris Capirossi Retires, Riders Pay Tribute</a></h4>
                                <p class="kp-metadata"><span>- October 23, 2013</span></p>
                            </div>
                    ...
                    <li>
                        <div class="item clearfix">
                            <a href="#" class="pull-left"><img src="placeholders/posts/img-10.jpg" alt=""></a>
                            <div class="item-right">
                                <h4><a href="#">Loris Capirossi Retires, Riders Pay Tribute</a></h4>
                                <p class="kp-metadata"><span>- October 23, 2013</span></p>
                            </div>
            ...
            <div class="widget widget_categories">
                ...
                <ul>
                    <li><a href="#">Business</a> (10)</li>
                    <li><a href="#">Health</a> (10)</li>
                    <li><a href="#">Movies</a> (10)</li>
                    <li><a href="#">Graphic Design</a> (10)</li>
                    <li><a href="#">Technology</a> (10)</li>
                </ul>
            </div>
            <!-- widget_categories -->
            <div class="widget widget-ads">
                <a href="#"><img src="placeholders/ads2.jpg" alt=""></a>
            </div>
            <!-- widget-ads -->
            ...
            <div class="widget widget-video">
                  ...
                  <div class="item-video">
                    <div class="video-wrapper">
                      <iframe width="300" height="225" src="https://www.youtube.com/embed/jgEW2_lJY6E" frameborder="0" allowfullscreen></iframe>
                    </div>
                    <h4><a href="#">Pakistani Taliban leader killed, U.S. ambassador summoned</a></h4>
                  </div>
                  <!-- item-video -->
                   ...
                   <ul class="list-posts list-unstyled">
                      ...
                      <li>
                        <div class="item clearfix">
                          <div class="item-right">
                            <h4><a href="#">US labour market shows strong rise: 236,000 new strong rise: 236,000 new</a></h4>
                            <p class="kp-metadata"><span>- October 23, 2013</span></p>
                          </div>
                        </div>
                      </li>
          ...
          <div class="widget widget-newsletter">
            <div class="widget-content">
              <h3 class="pull-left">
                ...
                <span>Stay up - to date with the latest news and other stuffs Sign Up today!</span>
              </h3>
              <form action="https://upsidethemes.net/" method="post" class="newsletter-form">
                      <input type="text" onfocus="if(this.value==this.defaultValue)this.value='';" onblur="if(this.value=='')this.value=this.defaultValue;" name="email" value="Email adress" class="form-control">
          ...
          <div class="widget widget-more-news multimedia">
              ...
              <ul class="list-unstyled clearfix">
                <li>
                  <div class="item">
                    <a href="#" class="caption">
                      <img src="placeholders/posts/img-16.jpg" alt="">
                      <span><i class="icon-images"></i></span>
                    </a>
                    <p class="kp-metadata"><span>Key Ingredient</span></p>
                    <h3><a href="#">Pakistani Taliban leader killed, U.S. ambassador summoned</a></h3>
                    <p>Pakistani Taliban leader killed, U.S. ambassador summoned</p>
                  </div>
                </li>
                 <li>
                  <div class="item">
                 ...
                 <li>
                  <div class="item">
                    <a href="#" class="caption">
                      ...
                      <span><i class="icon-volumefull"></i></span>
                      <p>3:30</p>
                    </a>
                    <p class="kp-metadata"><span>Key Ingredient</span></p>
                    <h3><a href="#">Pakistani Taliban leader killed, U.S. ambassador summoned</a></h3>
    ...
    <div id="page-footer" class="container">
      ...
      <ul class="kp-links list-inline">
        <li><a href="#">Subscribe To Click news</a></li>
        <li><a href="#">Privacy Policy</a></li>
        <li><a href="#">Your Privacy Rights</a></li>
        <li><a href="#">Terms of Use</a></li>
      </ul>
      <p class="copy-right">Copyright 2013- <span>Kopasoft</span>. All rights Reserved</p>
    </div>
    <!-- page-footer -->
