...
class SystemUser extends TRecord
{
    ...
    public function __construct($id = NULL)
    {
        ...
        parent::addAttribute('tipoUsuario');
    }


    function getFoto(){
        $filename = "files/users/".$this->foto;
        $foto =  is_file($filename)? $filename : "app/templates/theme4/images/user.png";
        return  $foto;
    }
    ...
    public static function getUserById($id){
        \Adianti\Database\TTransaction::open('permission');
