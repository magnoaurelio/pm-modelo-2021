...
class IssuuClient {
  ...
  public function __construct($apiAddress) {
    $this->_publicKey = "w7gaavla35y0wnpwg8fofw8o66t3vmhx"; // Public API key here
    $this->_privateKey = "k3nthcnmpgvf5zd2rcnmzxtuzni0l58o"; // Private API key here
