        ...
        <div class="container">
            <nav class="pull-left">
                ...
                <ul class="sf-menu main-menu">
                    ...
                    <li class="current-menu-item">
                        <a href="?p=alimentacao"><i class="fa fa-cutlery fl-fg"></i></i> Alimentação</a>                            
                    </li>
                    <li class="current-menu-item">
                       <a href="?p=galeria" title="Fotos de: {header_nome}"><i class="fa fa-vid fa-picture-o fl-fg"></i> Galeria</a>
                    ...
                    <li>
                        <a href="#" title="Notícias Diversas"><i  class="fa fa-newspaper-o fl-fg"></i></i> Notícias</a>
                          <ul>
                            <li>
                                <a href="?p=noticia_geral"><i class="icon-feed2"></i>Notícia Geral</a>
                                <ul>
                            ...
                            <li>
                                <a href="?p=noticia_bloco"><i class="icon-feed2"></i>Notícia Bloco</a>
                                <ul>
                    ...
                    <li>
                        <a href="?p=video" title="Vídeos Oficiais"><i class="fa fa-vid fa-video-camera fl-fg"></i> Vídeo</a>
                    </li>
                    <li><a href="?p=contato" title="Galeria de Fotos"><i  class="fa fa-bus fl-fg"></i> </i> Turísmo</a></li> 
                    <li><a href="?p=contato" title="Contatos da Administração"><i class="icon-phone"></i> Contato</a></li>   
                </ul>
...
<div id="page-footer" class="container">
    ...
    <div class="col-sm-right col-4">
     <h5 class="item-left"> Redes Socias<h5>
     <p class="kp-social">
