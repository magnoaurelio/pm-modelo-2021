...
<div class="widget-area-1" style="margin-top: -17px;">
               ...
               <!-- item -->
            <?php
            $publicidadeHome = new Publicidade(Publicidade::MUNICIPIO . " and pubtipocodigo = 'DI' ");
            foreach ($publicidadeHome->getResult() as $publicidade) {
            ?>
                <h4 class="widget-title">Publicidade: 5<br/><strong> <?=$publicidade['pubtitulo'] ?></strong> </h4>
