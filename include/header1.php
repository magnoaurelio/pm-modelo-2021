        ...
        <div class="container">
            <nav class="pull-left">
                <ul class="sf-menu main-menu">
                    ...
                    <li class="current-menu-item">
                        <a href="http://api.municipiaui.com/acesso">
    ...
    <div class="header-middle container clearfix">
        ...
        <div class="logo pull-left">
            ...
            <p class="kp-social pull-right">
                ...
                <a href="./index.php"><?=$prefeitura->prenome?> <!--SANTA CRUZ DOS MILAGRES-->
                 <img src="images/natal05.jpg" width="40" height="40" alt="imagem" >
                </a>
            </p>

        </div>
        <div class="logo pull-left" style="margin-left: -150px">
        ...
        <div class="logo pull-left" style="margin-left: 0px">
            <a href="./index.php" title="Logomarca Oficial de: <?=$prefeitura->prenome?> ">
                <img src="<?= FILES . 'prefeituras/' . UNIDADE_GESTORA . '/' . $prefeitura->prelogo?>" width="250" height="70" alt="logo"
                     class="img-responsive">
            </a>
        </div>
        <div class="logo pull-right" style="margin-left: 00px">
            <a href="./index.php" title="Imagem  de: <?=$prefeitura->prenome?> ">
                <img src="<?= FILES . 'prefeituras/' . UNIDADE_GESTORA . '/' . $prefeitura->preimagem?>"  alt="imagem" class="img-responsive">
            </a>
        </div>
        <!--p class="kp-social pull-right">
            <a href="#" class="icon-google-plus2"></a>
