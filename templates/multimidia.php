       ...
       <?php
        ...
        <div id="main-col" class="pull-left">
            <ul class="breadcrumb">
              ...
              <li class="active">Multimídia</li>
            </ul>
            <article class="post-content">
              
              <header class="clearfix">
                <h3 class="title-post">Imagens, Vídeos e Áudios de AGRICOLÂNDIA </h3>
              ...
              <div class="kp-gallery">
               <div class="flexslider kp-gallery-slider">
                ...
                <nav>
                  <span class="total">Total: <span>9</span> fotos</span>
        ...
        <div class="widget-area-5">
          <div class="multimedia clearfix">
            <h3 class="multimedia-title kp-title">image Diversos
                <a class="prev" href="#"></a>
                <a class="next" href="#"></a>
            </h3>
              <?php
           ...
           ?>
            <h3 class="multimedia-title kp-title">videos Diversos
               <a class="prev" href="#"></a>
               <a class="next" href="#"></a>
            </h3>
            <?php
           ...
           ?>
            <h3 class="multimedia-title kp-title">audio Diversos
                <a class="prev" href="#"></a>
                <a class="next" href="#"></a>
            </h3>
           <?php
